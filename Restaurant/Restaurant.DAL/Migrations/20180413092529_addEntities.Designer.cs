...
namespace Restaurant.DAL.Migrations
{
    ...
    [Migration("20180413092529_addEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Restaurant.BLL.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Restaurant.BLL.Entities.SmallTableReservation", b =>
                {
                    ...
                    b.HasKey("SmallTableId", "ReservationId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("Restaurant.BLL.Entities.Role")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Restaurant.BLL.Entities.User")
                        .WithMany()
            ...
            modelBuilder.Entity("Restaurant.BLL.Entities.SmallTableReservation", b =>
                {
                    b.HasOne("Restaurant.BLL.Entities.Reservation", "Reservation")
                        .WithMany("SmallTables")
                        .HasForeignKey("ReservationId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Restaurant.BLL.Entities.SmallTable", "SmallTable")
                        .WithMany("Reservations")
                        .HasForeignKey("SmallTableId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
